...
public class Login extends JFrame {
	...
	public static BidderInfo bidder;
	...
	public Login() throws UnknownHostException, IOException {
		...
		lblAdminPortal = new JLabel("Bidder Portal");
		...
		label2=new JLabel("AUCTION POOL LOGIN");
		label2.setForeground(Color.WHITE);
		label2.setFont(new Font("Dialog", Font.BOLD, 25));
		label2.setBounds(469,79,354,60);
		contentPane.add(label2);
		
		icon2=new ImageIcon("/home/tharun30/Package_sem5/Online-Auction-System-master/ProjectImages2/login.jpg");
		...
		lblNewLabel.setIcon(new ImageIcon("/home/tharun30/Package_sem5/Online-Auction-System-master/ProjectImages2/Login2.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("/home/tharun30/Package_sem5/Online-Auction-System-master/ProjectImages2/User5.png"));
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("/home/tharun30/Package_sem5/Online-Auction-System-master/ProjectImages2/pwd3.png"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try 
				{
					bidder.name=username;
					bidder.password=pass;
				...
				{
					try {
						BidderFrame frame = new BidderFrame(thisframe,input,output);
						frame.setVisible(true);
