...
public class AdminFrame extends JFrame {
    ...
    public JLabel label_1,lblYouCanSell,lblWillStartAt,label, lblAuctionPool,lblPvtltd,label3, lblBidder;
	public ImageIcon icon,icon2,icon3,icon4;
	public JPanel panel,panel_1,panel_2,panel_3;
	public JButton btnStartAuction,btnNewButton,btnEnterCutoffOf,button2,button_1,btnLogout, btnShowPlayers;
	...
	public AdminFrame(AdminLogin parent,ObjectInputStream input,ObjectOutputStream output) throws Exception{
		...
		icon=new ImageIcon("/home/tharun30/AuctionPulse/ProjectImages2/index.png");
		...
		icon2=new ImageIcon("/home/tharun30/AuctionPulse/ProjectImages2/Frame2.jpg");
		
		ServerCollection.PlayerList =(Vector<Player>) input.readObject();
		
		lblBidder = new JLabel("Admin Portal");
		lblBidder.setForeground(new Color(224, 255, 255));
		lblBidder.setBounds(712,127,187,32);
		...
		contentPane.add(bidderlist);
		bidderlist.setVisible(false);
		
		result=new Result();
		contentPane.add(result);
		result.setVisible(false);
		
		icon4=new ImageIcon("/home/tharun30/AuctionPulse/ProjectImages2/a1.jpg");
		panel_2.setLayout(null);
		label_1 = new JLabel(icon4);
		label_1.setBounds(70, 23, 843, 517);
		panel_2.add(label_1);
		
		lblYouCanSell = new JLabel("Upload the images of Players for Auction, Then Start the Auction.");
		...
		lblWillStartAt = new JLabel("Bidders will Bid them in the Auction.");
		...
		icon3=new ImageIcon("/home/tharun30/AuctionPulse/ProjectImages2/logo.png");
		label=new JLabel(icon3);
		label.setBounds(85, 3, 140, 100);
		contentPane.setLayout(null);
		contentPane.add(label);
		
		btnNewButton = new JButton("Add Players");
		...
		btnEnterCutoffOf = new JButton("Show Sold Players");
		btnEnterCutoffOf.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) {
				...
				try 
				{
					...
					output.reset();
					ServerCollection.SoldPlayerList =(Vector<Player>)input.readObject();}
					result.refresh();
				} catch (Exception e2) 
				{
					e2.printStackTrace();
		...
		button2 = new JButton("Show Bidders");
		button2.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) {
				...
				sell.setVisible(false);
				startAuction.setVisible(false);
				bidderlist.setVisible(true);
				result.setVisible(false);
				showPlayers.setVisible(false);
				try 
				{
					synchronized(output) {
					output.writeObject("BidderDetails");
					output.reset();
					bidders =(AllBidders)input.readObject();}
					ServerCollection.bidders = bidders.info;
				} catch (Exception e2) 
				{
					e2.printStackTrace();
				}
		...
		btnShowPlayers = new JButton("Show Players");
		...
		btnShowPlayers.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				...
				btnShowPlayers.setBackground(new Color(0, 0, 77));
				btnShowPlayers.setForeground(Color.white);
			}
			

			public void mouseEntered(MouseEvent e) {
				
				btnShowPlayers.setBackground(new Color(0, 115, 230));
				btnShowPlayers.setForeground(Color.white);
			}
		});
		btnShowPlayers.setBounds(0, 114, 300, 60);
		panel_1.add(btnShowPlayers);
		btnShowPlayers.setForeground(Color.WHITE);
		btnShowPlayers.setFont(new Font("Dialog", Font.BOLD, 23));
		btnShowPlayers.setFocusable(false);
		btnShowPlayers.setBorder(new LineBorder(new Color(0, 128, 255),3));
		btnShowPlayers.setBackground(new Color(0, 0, 77));
		...
		lblAuctionPool = new JLabel("IPL Auction Pool");
		lblAuctionPool.setHorizontalAlignment(SwingConstants.CENTER);
		lblAuctionPool.setForeground(Color.YELLOW);
		lblAuctionPool.setBounds(590, 25, 340, 35);
		lblAuctionPool.setFont(new Font("Dialog", Font.BOLD, 35));
		contentPane.add(lblAuctionPool);
