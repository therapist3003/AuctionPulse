...
public class Result extends JPanel {
	...
	public Result() {
		...
		ServerCollection.soldplayers =new HashMap<Integer, Player>();
	...
	public void refresh() throws Exception
	{
		...
		Iterator<Player> i=ServerCollection.SoldPlayerList.iterator();
		ServerCollection.soldplayers.clear();
		...
		while(i.hasNext())
		{
			...
			ServerCollection.soldplayers.put(player.ID, player);
			ServerCollection.soldImages.put(player.ID,image);
