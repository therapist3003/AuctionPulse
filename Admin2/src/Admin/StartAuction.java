	...
	public StartAuction(ObjectInputStream input,ObjectOutputStream output,AuctionRunning parent,Sell sell) throws Exception{
		...
		btnStartAuction.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!ServerCollection.PlayerList.isEmpty())
				{
				...
				{
					JOptionPane.showMessageDialog(null,"No Players in System,Please add Players First");
				}
			}
		});
...
//		System.out.println("flag: " + flag);
		if(status && !flag)
		{
			System.out.println("Reached status and flag if");
