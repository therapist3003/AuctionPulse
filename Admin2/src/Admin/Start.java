...
public class Start extends JPanel{
	...
	public Start(ObjectInputStream input,ObjectOutputStream output) throws Exception {
		...
		lblFillTheFollowing = new JLabel("Player for Auction");
